...
if __name__ == "__main__":
    ...
    serial_image = mandelbrot_serial(N, X_MIN, X_MAX, Y_MIN, Y_MAX, MAX_ITER)
    parallel_image = mandelbrot_parallel(
        N, X_MIN, X_MAX, Y_MIN, Y_MAX, MAX_ITER, N_WORKERS
    )

    print("Serial shape:", serial_image.shape)
    print("Parallel shape:", parallel_image.shape)
    print("Same result:", np.array_equal(serial_image, parallel_image))